...
export const APINew = () => {
  ...
  return (
    <DashboardWrapper>
      <div className='text-2xl'>Create New API.</div>
      <div className='relative w-full grid grid-cols-2'>
        <form className='w-full flex flex-col items-center space-y-8 border-r border-gray-300'>
          ...
          <div className='w-4/5 flex flex-col items-start justify-start space-y-2'>
            ...
            <label className='text-left text-sm text-gray-500'>
              ...
              in a backend environment, and do tasks that are require high level
              of security.
            </label>
          </div>
          <div className='w-4/5 flex flex-col items-start justify-start space-y-2'>
