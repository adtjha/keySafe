  ...
  return (
    <div className='px-16 py-2 w-full flex flex-row items-center justify-center content-center space-x-8 bg-secondary-dark text-secondary-text'>
      <div className='w-fit flex-grow flex flex-row items-center justify-start space-x-8'>
        <Link to='/' className='text-base font-bold font-mono flex flex-row items-center justify-evenly hover:underline px-2 hover:bg-primary-light hover:text-primary-text rounded-lg'>
        ...
        <Link to='/profile' className='px-2 rounded-lg text-base font-bold font-mono flex flex-row items-center justify-evenly hover:underline hover:bg-primary-light hover:text-primary-text'>
          <svg xmlns='http://www.w3.org/2000/svg' className='h-4 w-4' viewBox='0 0 20 20' fill='currentColor'>
      ...
      <button onClick={() => send("LOGOUT")} className='px-2 rounded-lg text-base font-bold font-mono flex flex-row items-center justify-evenly hover:underline hover:bg-primary-light hover:text-primary-text'>
        <svg xmlns='http://www.w3.org/2000/svg' className='h-4 w-4' viewBox='0 0 20 20' fill='currentColor'>
...
const SubMenu = () => {
  return (
    <React.Fragment>
      <div className='transition-all before:-top-2 before:block before:h-2 before:w-full before:absolute absolute top-8 left-0 z-[999] w-max p-2 hidden group-hover:flex flex-col items-start justify-center gap-2 bg-transparent '>
